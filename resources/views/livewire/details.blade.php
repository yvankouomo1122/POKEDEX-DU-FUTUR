<div class="md:container md:px-10 lg:px-0 mx-auto relative min-h-screen flex flex-col pb-24 md:items-center md:justify-center mt-20">
    <div
        ...
        <div class="md:w-1/2 md:inline hidden rounded-l-xl bg-cover bg-no-repeat bg-center bg-slate-200"
            style="background-image: url('{{ asset('storage/'. $pok->image) }}');">
        </div>
        <img src="{{ asset('storage/'. $pok->image) }}" class="md:hidden bg-slate-200 md:rounded-t-xl" alt="" srcset="">
        <div class="p-5 flex-1 relative flex flex-col">
            <div class="flex justify-between items-center">
                <h1 class="text-5xl font-semibold dark:text-white">{{ $pok->name }}</h1>
                <a href="/" class="bg-red-500 hover:bg-red-700 text-black dark:text-white font-bold py-2 px-4 rounded-full inline-flex items-center justify-center">
                    <i class="fas fa-times-circle fa-2xl" aria-hidden="true"></i>
                </a> 
            </div>
            <div class="grid grid-cols-2 gap-4 mt-8 dark:text-white">
            ...
            <div class="flex flex-col flex-1 gap-4 mt-10 overflow-y-auto dark:text-white">
                <h2 class="text-3xl font-semibold italic">Attaques:</h2>
                <div class="grid grid-cols-1 gap-2 border-separate">
                    <div class="flex gap-2 cursor-pointer  transition-all duration-300 p-1"
